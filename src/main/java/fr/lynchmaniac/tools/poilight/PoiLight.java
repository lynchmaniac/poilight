...
public class PoiLight {
	...
	public static void generateExcel(Workbook wb, String filePath, LinkedHashMap<Integer, RowContent> data, boolean isStreaming, String sheetName, BoardStyles bs, int firstRow, int firstCol) {
		...
		createSheet(wb, data, isStreaming, null, bs, firstRow, firstCol);
	 ...
	 * @param isStreaming indicates whether to write the streaming file
	 */
	public static void createSheet(Workbook wb, LinkedHashMap<Integer, RowContent> data, boolean isStreaming) {
		createSheet(wb, data, isStreaming, null, null);
	}
	 ...
	 * @param bs all properties suitable on the style of a cell
	 */
	public static void createSheet(Workbook wb, LinkedHashMap<Integer, RowContent> data, boolean isStreaming, String sheetName, BoardStyles bs) {
		createSheet(wb, data, isStreaming, sheetName, bs, 0, 0);	
	}
	 ...
	 * @param firstCol the index of the first column
	 */
	public static void createSheet(Workbook wb, LinkedHashMap<Integer, RowContent> data, boolean isStreaming, String sheetName, BoardStyles bs, Integer firstRow, Integer firstCol) {
		//New Sheet
	 ...
	 */
	private static Integer controlRowIndex(Workbook wb, LinkedHashMap<Integer, RowContent> data, Integer firstRow) {
